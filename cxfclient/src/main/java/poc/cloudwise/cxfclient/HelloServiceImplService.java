 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://impl.service.cloudwise.poc/", wsdlLocation = "http://10.0.7.82:8080/cxfserver/ws/soap/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.cloudwise.poc/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.0.7.82:8080/cxfserver/ws/soap/hello?wsdl");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://impl.service.cloudwise.poc/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.cloudwise.poc/", "HelloServiceImplPort"), HelloService.class, features);
    }
