 ...
 * generated in the poc.cloudwise.cxfclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayResponse_QNAME = new QName("http://service.cloudwise.poc/", "sayResponse");
    private final static QName _Say_QNAME = new QName("http://service.cloudwise.poc/", "say");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: poc.cloudwise.cxfclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cloudwise.poc/", name = "sayResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.cloudwise.poc/", name = "say")
